...
const HeroSection = () => {
  ...
  return <section className="relative min-h-screen flex items-center justify-center pt-20">
      ...
      <div className="absolute inset-0 z-0">
        <img src={heroImage} alt="Pareja romántica" className="w-full h-full object-cover" />
      ...
      <div className="relative z-10 container mx-auto px-4 text-center py-20">
        <div className="max-w-3xl mx-auto">
          ...
          <Button size="lg" onClick={scrollToPayment} className="text-lg px-8 py-6 shadow-lg hover:shadow-xl transition-all duration-300">
